...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(100, 100, Math.PI, Math.PI, 2)
                .setDimensions(18,18)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(14.25, -62.13, Math.toRadians(90.00)))
                        ...
                        .splineToLinearHeading(new Pose2d(30,-55,Math.toRadians(-90.00)),Math.toRadians(-90.00))
                                .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(13, -43,Math.toRadians(90.00)),Math.toRadians(90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(30,-55,Math.toRadians(-90.00)),Math.toRadians(-90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(14, -43,Math.toRadians(90.00)),Math.toRadians(90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(30,-55,Math.toRadians(-90.00)),Math.toRadians(-90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(15, -43,Math.toRadians(90.00)),Math.toRadians(90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(30,-55,Math.toRadians(-90.00)),Math.toRadians(-90.00))
                        .waitSeconds(1)
                        .splineToLinearHeading(new Pose2d(16, -43,Math.toRadians(90.00)),Math.toRadians(90.00))
                        .waitSeconds(1)
                        .build()
