...
public class TestAotun extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder sp = drive.actionBuilder(initialPose)
                .splineToConstantHeading(new Vector2d(12.57, -40), Math.toRadians(90.00));


        TrajectoryActionBuilder sp2 = drive.actionBuilder(new Pose2d(12.57, -40, Math.toRadians(90.00)))
                .splineToConstantHeading(new Vector2d(35.67, -40), Math.toRadians(90.00));
